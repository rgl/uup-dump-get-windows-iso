...
$backgroundColor = [System.Drawing.Color]::FromArgb(0x51, 0x51, 0x51)
$backgroundPath = 'C:\Windows\Web\Wallpaper\Windows\logo.png'
$logo = [System.Drawing.Image]::FromFile((Resolve-Path 'logo.png'))
